...
export const paymentsApi = {
    list: async (shopId: string, status?: PaymentStatus): Promise<PaginatedResponse<Payment>> => {
        const response = await apiClient.get(`/api/v1/shops/${shopId}/payments`, {
            params: { status },
        });
